...
let {deployRouter,deploySwapAdapter,tronSetAuthorization,tronSetAuthFromConfig,tronSetFeeManager} = require("./utils/tronRouter.js")


task("router", "deploy router and set up")
...
task("router:deploySwapAdapter", "deploy SwapAdapter")
    .setAction(async (taskArgs,hre) => {
...
task("router:setFeeManager", "deploy SwapAdapter")
