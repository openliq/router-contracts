...
contract Router is Ownable2Step,ReentrancyGuard {  
    ...
    event CollectFee(address indexed token,address indexed receiver,address indexed integrator,uint256 amount,uint256 nativeAmount,bytes32 transferId);
    ...
    function _collectFee(address _token, uint256 _amount,bytes32 transferId,address integrator) internal returns(uint256 _remain){
